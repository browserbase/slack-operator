...
export class Agent {
  ...
  async getAction(
    ...
    const request = {
      ...
      reasoning: { generate_summary: "concise" as const },
      ...(previousResponseId
        ? { previous_response_id: previousResponseId, instructions: "Use the web browser to complete the task. If needed, always use the additional back() and goto() functions to navigate the browser. If you get stuck, trying going to Google." }
        : {}),
    }
